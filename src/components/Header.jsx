        ...
        <div className="min-h-screen mb-4 bg-cover bg-center flex items-center w-full overflow-hidden" style={{backgroundImage:"url(/header_img.png)"}} id="Header">
            ...
            <div className="container text-center mx-auto py-4 px-6 md:px-20 lg:px-32 text-white">
                ...
                <div className="space-x-6 mt-16">
                    <a className="border border-white px-8 py-3 rounded hover:bg-slate-400 hover:text-white duration-300" href="#Projects">Projects</a>
                    <a className="bg-blue-500 px-8 py-3 rounded hover:bg-slate-400 hover:text-white duration-300" href="#Contact">Contact Us</a>
                </div>
            </div>
        </div>
    );
